...
@register_run('credit_glofair_dp_multiple_attributes')
class CreditGlofairDPMultipleAttributesRun(CreditRun):
    def __init__(self,**kwargs) -> None:
        super(CreditGlofairDPMultipleAttributesRun, self).__init__(**kwargs)
        self.project_name = 'CreditGlofairDPMultipleAttributesAlpha2'
        self.num_clients = 10
        self.lr=1e-4
