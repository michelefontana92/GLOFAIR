...
@register_run('credit_glofair_dp_eod_gender')
class CreditGlofairDPEODGenderRun(CreditRun):
    def __init__(self,**kwargs) -> None:
        super(CreditGlofairDPEODGenderRun, self).__init__(**kwargs)
        self.project_name = 'CreditGlofairDPEODGender'
        self.num_clients = 10
        self.lr=1e-4
