...
@register_run('credit_glofair_eod_gender_age')
class CreditGlofairEODGenderAgeRun(CreditRun):
    def __init__(self,**kwargs) -> None:
        super(CreditGlofairEODGenderAgeRun, self).__init__(**kwargs)
        self.project_name = 'CreditGlofairEODGenderAge'
        self.num_clients = 10
        self.lr=1e-4
