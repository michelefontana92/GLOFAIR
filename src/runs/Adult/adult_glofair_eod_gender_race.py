...
@register_run('adult_glofair_eod_gender_race')
class AdultGlofairEODGenderRaceRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultGlofairEODGenderRaceRun, self).__init__(**kwargs)
        self.project_name = 'AdultGlofairEODGenderRace'
        self.num_clients = 10
        self.lr=1e-4
