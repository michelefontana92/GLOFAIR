...
@register_run('adult_glofair_dp_gender_race')
class AdultGlofairDPGenderRaceRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultGlofairDPGenderRaceRun, self).__init__(**kwargs)
        self.project_name = 'AdultGlofairDPGenderRaceFairnessInjected'
