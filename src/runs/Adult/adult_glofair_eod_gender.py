...
@register_run('adult_glofair_eod_gender')
class AdultGlofairEODGenderRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultGlofairEODGenderRun, self).__init__(**kwargs)
        self.project_name = 'AdultGlofairEODGender'
        self.num_clients = 10
        self.lr=1e-4
