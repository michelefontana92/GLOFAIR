...
@register_run('adult_glofair_dp_eod_gender')
class AdultGlofairDPEODGenderRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultGlofairDPEODGenderRun, self).__init__(**kwargs)
        self.project_name = 'AdultGlofairDPEODGender'
