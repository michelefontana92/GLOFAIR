...
@register_run('compas_glofair_dp_gender_race')
class CompasGlofairDPGenderRaceRun(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasGlofairDPGenderRaceRun, self).__init__(**kwargs)
        self.project_name = 'CompasGlofairDPGenderRace'
        self.num_clients = 10
        self.lr=1e-4
