...
@register_run('compas_glofair_dp_eod_race')
class CompasGlofairDPEODRaceRun(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasGlofairDPEODRaceRun, self).__init__(**kwargs)
        self.project_name = 'CompasGlofairDPEODRace'
        self.num_clients = 10
        self.lr=1e-4
