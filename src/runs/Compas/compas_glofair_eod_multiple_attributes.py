...
@register_run('compas_glofair_eod_multiple_attributes')
class CompasGlofairEODMultipleAttributesRun(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasGlofairEODMultipleAttributesRun, self).__init__(**kwargs)
        self.project_name = 'CompasGlofairEODMultipleAttributes'
        self.num_clients = 10
        self.lr=1e-4
