...
@register_run('compas_glofair_dp_eod_gender_race')
class CompasGlofairDPEODGenderRaceRun(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasGlofairDPEODGenderRaceRun, self).__init__(**kwargs)
        self.project_name = 'CompasGlofairDPEODGenderRace'
        self.num_clients = 10
        self.lr=1e-4
