...
@register_run('compas_glofair_eod_race')
class CompasGlofairEODRaceRun(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasGlofairEODRaceRun, self).__init__(**kwargs)
        self.project_name = 'CompasGlofairEODRace'
        self.num_clients = 10
        self.lr=1e-4
