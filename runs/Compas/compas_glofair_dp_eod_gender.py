...
@register_run('compas_glofair_dp_eod_gender')
class CompasGlofairDPEODGenderRun(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasGlofairDPEODGenderRun, self).__init__(**kwargs)
        self.project_name = 'CompasGlofairDPEODGender'
        self.num_clients = 10
        self.lr=1e-4
            ...
            UnconstrainedRequirement(name='unconstraned_performance_requirement',
                    ...
                    ConstrainedRequirement(name='dp_requirement',
                                           metric = MetricsFactory.create_metric(
                                            ...
                                            operator='<=',
                                            threshold=0.2),
                     ConstrainedRequirement(name='eop_requirement',
                                           metric = MetricsFactory.create_metric(
