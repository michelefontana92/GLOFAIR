...
@register_run('compas_glofair_eod_gender_race')
class CompasGlofairEODGenderRaceRun(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasGlofairEODGenderRaceRun, self).__init__(**kwargs)
        self.project_name = 'CompasGlofairEODGenderRace'
        self.num_clients = 10
        self.lr=1e-4
