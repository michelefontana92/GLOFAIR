...
@register_run('compas_glofair_eod_gender')
class CompasGlofairEODGenderRun(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasGlofairEODGenderRun, self).__init__(**kwargs)
        self.project_name = 'CompasGlofairEODGender'
        self.num_clients = 10
        self.lr=1e-4
