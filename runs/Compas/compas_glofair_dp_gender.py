...
@register_run('compas_glofair_dp_gender')
class CompasGlofairDPGenderRun(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasGlofairDPGenderRun, self).__init__(**kwargs)
        self.project_name = 'CompasGlofairDPGenderAlpha2'
        self.num_clients = 10
        self.lr=1e-4
