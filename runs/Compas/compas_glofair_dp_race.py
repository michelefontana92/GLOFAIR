...
@register_run('compas_glofair_dp_race')
class CompasGlofairDPRaceRun(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasGlofairDPRaceRun, self).__init__(**kwargs)
        self.project_name = 'CompasGlofairDPRace'
        self.num_clients = 10
        self.lr=1e-4
