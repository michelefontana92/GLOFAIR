...
@register_run('adult_glofair_eod_race')
class AdultGlofairEODRaceRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultGlofairEODRaceRun, self).__init__(**kwargs)
        self.project_name = 'AdultGlofairEODRace'
        self.num_clients = 10
        self.lr=1e-4
