...
@register_run('adult_glofair_dp_eod_gender_race')
class AdultGlofairDPEODGenderRaceRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultGlofairDPEODGenderRaceRun, self).__init__(**kwargs)
        self.project_name = 'AdultGlofairDPEODGenderRace'
