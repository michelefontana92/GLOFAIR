...
@register_run('adult_glofair_eod_multiple_attributes')
class AdultGlofairEODMultipleAttributesRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultGlofairEODMultipleAttributesRun, self).__init__(**kwargs)
        self.project_name = 'AdultGlofairEODMultipleAttributes'
        self.num_clients = 10
        self.lr=1e-4
