...
@register_run('adult_glofair_dp_gender')
class AdultGlofairDPGenderRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultGlofairDPGenderRun, self).__init__(**kwargs)
        self.project_name = 'AdultGlofairDPGenderFairnessInjected'
        self.num_clients = 10
        self.lr=1e-4
