...
@register_run('adult_glofair_dp_multiple_attributes')
class AdultGlofairDPMultipleAttributesRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultGlofairDPMultipleAttributesRun, self).__init__(**kwargs)
        self.project_name = 'AdultGlofairDPMultipleAttributesFairnessInjected'
        self.num_clients = 10
        self.lr=1e-4
