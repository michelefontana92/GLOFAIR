...
@register_run('adult_glofair_dp_race')
class AdultGlofairDPRaceRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultGlofairDPRaceRun, self).__init__(**kwargs)
        self.project_name = 'AdultGlofairDPRaceFairnessInjected'
        self.num_clients = 10
        self.lr=1e-4
