...
@register_run('credit_glofair_dp_eod_age')
class CreditGlofairDPEODAgeRun(CreditRun):
    def __init__(self,**kwargs) -> None:
        super(CreditGlofairDPEODAgeRun, self).__init__(**kwargs)
        self.project_name = 'CreditGlofairDPEODAge'
        self.num_clients = 10
        self.lr=1e-4
