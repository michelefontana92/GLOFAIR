...
@register_run('credit_glofair_eod_age')
class CreditGlofairEODAgeRun(CreditRun):
    def __init__(self,**kwargs) -> None:
        super(CreditGlofairEODAgeRun, self).__init__(**kwargs)
        self.project_name = 'CreditGlofairEODAge'
        self.num_clients = 10
        self.lr=1e-4
