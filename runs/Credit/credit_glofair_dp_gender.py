...
@register_run('credit_glofair_dp_gender')
class CreditGlofairDPGenderRun(CreditRun):
    def __init__(self,**kwargs) -> None:
        super(CreditGlofairDPGenderRun, self).__init__(**kwargs)
        self.project_name = 'CreditGlofairDPGenderAlpha2'
        self.num_clients = 10
        self.lr=1e-4
