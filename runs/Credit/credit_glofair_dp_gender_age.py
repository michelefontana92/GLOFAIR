...
@register_run('credit_glofair_dp_gender_age')
class CreditGlofairDPGenderAgeRun(CreditRun):
    def __init__(self,**kwargs) -> None:
        super(CreditGlofairDPGenderAgeRun, self).__init__(**kwargs)
        self.project_name = 'CreditGlofairDPGenderAge'
        self.num_clients = 10
        self.lr=1e-4
