...
@register_run('credit_glofair_eod_gender')
class CreditGlofairEODGenderRun(CreditRun):
    def __init__(self,**kwargs) -> None:
        super(CreditGlofairEODGenderRun, self).__init__(**kwargs)
        self.project_name = 'CreditGlofairEODGender'
        self.num_clients = 10
        self.lr=1e-4
