...
@register_run('credit_glofair_dp_age')
class CreditGlofairDPAgeRun(CreditRun):
    def __init__(self,**kwargs) -> None:
        super(CreditGlofairDPAgeRun, self).__init__(**kwargs)
        self.project_name = 'CreditGlofairDPAge'
        self.num_clients = 10
        self.lr=1e-4
