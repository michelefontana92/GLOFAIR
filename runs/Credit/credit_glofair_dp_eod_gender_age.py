...
@register_run('credit_glofair_dp_eod_gender_age')
class CreditGlofairDPEODGenderAgeRun(CreditRun):
    def __init__(self,**kwargs) -> None:
        super(CreditGlofairDPEODGenderAgeRun, self).__init__(**kwargs)
        self.project_name = 'CreditGlofairDPEODGenderAge'
        self.num_clients = 10
        self.lr=1e-4
